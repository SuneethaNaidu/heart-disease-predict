...
Chest paintype= st.number_input('Enter in digits')
...
if st.button('Predict Heart Disease'):
    prediction=model.predict([[Age,Sex,Chest paintype,BP,Cholestrol,FBS,EKG results,MAX HR,Exercise agina,ST depression,Slope of ST,Number of vessels fluro,Thallium]])
    if prediction=='Y':
